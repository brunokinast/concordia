...
<html lang="en">
  ...
  <body>
    ...
    <div class="d-flex justify-content-center h-100">
      <div class="moto_card" style="height: 680px; margin-top: 8%;">
        ...
        <div class="d-flex justify-content-center form_container">
          <form action="<?= base_url(); ?>motorista/cadastro/submit" method="POST">
            <p><center style="color: white;">Cadastro Motorista</center></p>
            ...
            <div class="input-group mb-3">
              ...
              <input type="text" id="placa" name="placa" class="form-control input_user" placeholder="Placa veículo" required>
            </div>
            <div class="input-group mb-3">
              <div class="input-group-append">
                <span class="input-group-text"><i class="fas fa-id-card-alt"></i></span>
              </div>
              <input type="text" id="cnh" name="cnh" class="form-control input_user" placeholder="CNH" required>
            </div>
    ...
    <script>
      $(document).ready(function () {
        ...
        var $CampoCnh = $("#cnh");
        $CampoCnh.mask('00000000000', {reverse: true});
        var $CampoPlaca = $("#placa");
        $CampoPlaca.mask('AAAAAAA', {reverse: true});
    });
    </script>
  </body>
</html>